...
(function(){
  ...
  var SPRITE_SHEET_SRC = 'data:image/png;base64,';
  var LEFT_KEY = 37;
  var RIGHT_KEY = 39;
  var SHOOT_KEY = 32;
  ...
  var Player = SheetSprite.extend({
    ...
    shoot: function() {
      var bullet = new Bullet(this.position.x, this.position.y - this.bounds.h / 2, 1, 700);
  ...
  function updateAliens(dt) {
    ...
    for (var i = aliens.length - 1; i >= 0; i--) {
      ...
      alien.stepDelay = ((alienCount * 20) - (wave * 15)) / 1000;
  ...
  function drawBottomHud() {
    ...
    fillText('HIGH SCORE: ', CANVAS_WIDTH - 200, CANVAS_HEIGHT - 7.5);
